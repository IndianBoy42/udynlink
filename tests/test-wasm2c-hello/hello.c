...
#include <stdarg.h>
#include <stddef.h>
/* bare-metal: replaced by builtins */
...
static u32 w2c_hello_get_len_0(w2c_hello*);
static u32 w2c_hello_get_char_0(w2c_hello*, u32);

FUNC_TYPE_T(w2c_hello_t0) = "\x72\xab\x00\xdf\x20\x3d\xce\xa1\xf2\x29\xc7\x9d\x13\x40\x7e\x98\xac\x7d\x41\x4a\x53\x2e\x42\x42\x61\x55\x2e\xaa\xeb\xbe\xc6\x35";
FUNC_TYPE_T(w2c_hello_t1) = "\x07\x80\x96\x7a\x42\xf7\x3e\xe6\x70\x5c\x2f\xac\x83\xf5\x67\xd2\xa2\xa0\x69\x41\x5f\xf8\xe7\x96\x7f\x23\xab\x00\x03\x5f\x4a\x3c";
...
static void init_memories(w2c_hello* instance) {
  ...
  LOAD_DATA(instance->w2c_memory, 0u, data_segment_data_w2c_hello_d0, 12);
}
...
/* export: 'get_len' */
u32 w2c_hello_get_len(w2c_hello* instance) {
  return w2c_hello_get_len_0(instance);
}

/* export: 'get_char' */
u32 w2c_hello_get_char(w2c_hello* instance, u32 var_p0) {
  return w2c_hello_get_char_0(instance, var_p0);
}

void wasm2c_hello_instantiate(w2c_hello* instance) {
...
u32 w2c_hello_get_len_0(w2c_hello* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = 12u;
  FUNC_EPILOGUE;
...
u32 w2c_hello_get_char_0(w2c_hello* instance, u32 var_p0) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = var_p0;
